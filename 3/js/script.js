...
function saveFilm() {
    ...
    const filmHours = parseFloat(document.getElementById("film-hours").value) || 0;
    const filmMinutes = parseFloat(document.getElementById("film-minutes").value) || 0;
    ...
    if (filmName && totalMinutes > 0 && filmIMDbRating && filmNumberReviews) {
        if (editFilmId !== null) {
...
function renderFilms(filmArray = films) {
    ...
    filmArray.forEach(film => { 
        ...
        filmElement.innerHTML = `
            ...
            <p class="film-info">Reviews: ${film.number_reviews} reviews</p> <button class="edit-btn" onclick="editFilm(${film.id})">Edit</button>
